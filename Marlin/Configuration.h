...
#define STRING_CONFIG_H_AUTHOR "LPomykal.cz, @sergi4d" // Who made the changes.
...
//#define MAGNETIC_PARKING_EXTRUDER
  ...
  //#define MANUAL_SOLENOID_CONTROL                   // Manual control of docking solenoids with M380 S / M381
    ...
    #define MPE_FAST_SPEED      9000      // (mm/m)  for travel before last distance point
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 406.82 }
...
//#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.20 } //volcano -22.50   AC block -16.20
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.8 }   // Z offset: -below +above  [the nozzle]
#elif ANYCUBIC_PROBE_VERSION == 1
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.0 }   // Z offset: -below +above  [the nozzle]
#elif ANYCUBIC_PROBE_VERSION == 3
    #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -0.25 }  // Z offset para la sonda de espuma
#else
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 }   0   // Z offset: -below +above  [the nozzle]
#endif
